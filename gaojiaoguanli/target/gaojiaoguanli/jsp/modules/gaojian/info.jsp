            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">稿件登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="zuozheName" name="zuozheName" class="form-control"
                                                   v-model="ruleForm.zuozheName" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="zuozheIdNumber" name="zuozheIdNumber" class="form-control"
                                                   v-model="ruleForm.zuozheIdNumber" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="zuozheAddress" name="zuozheAddress" class="form-control"
                                                   v-model="ruleForm.zuozheAddress" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="zuozheTime" name="zuozheTime" class="form-control"
                                                   v-model="ruleForm.zuozheTime" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>作者照片</label>
                                        <img id="zuozhePhotoImg" width="100" height="100">
                                    </div>
                            <!-- 本表所有字段 -->
                                ...
                                <input id="zuozheId" name="zuozheId" v-model="ruleForm.zuozheId" readonly type="hidden">
                                <input id="zhuanjiaId" name="zhuanjiaId" v-model="ruleForm.zhuanjiaId" readonly type="hidden">

                                    <div class="form-group col-md-6">
                                        <label>稿件名字</label>
                                        <input id="gaojianName" name="gaojianName" class="form-control"
                                               v-model="ruleForm.gaojianName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>稿件类型</label>
                                    <input id="gaojianValue" name="gaojianValue" class="form-control"
                                           v-model="ruleForm.gaojianValue" readonly>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="zhuanjiaName" name="zhuanjiaName" class="form-control"
                                           v-model="ruleForm.zhuanjiaName" readonly>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="zhuanjiaIdNumber" name="zhuanjiaIdNumber" class="form-control"
                                           v-model="ruleForm.zhuanjiaIdNumber" readonly>
                                </div>


                                <div class="form-group col-md-6">
                                    <label>专家照片</label>
                                    <img id="zhuanjiaPhotoImg" width="100" height="100">
                                </div>


                                <div class="form-group col-md-6">
                                    <label>审稿结果</label>
                                    <input id="gaojianYesnoValue" name="gaojianYesnoValue" class="form-control"
                                           v-model="ruleForm.gaojianYesnoValue" readonly>
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.gaojianContent != null && ruleForm.gaojianContent != 'null' && ruleForm.gaojianContent != '') {
            var gaojianContentUeditor = UE.getEditor('gaojianContentEditor');
                gaojianContentUeditor.ready(function () {
                    var mes = '' + ruleForm.gaojianContent;
                    gaojianContentUeditor.setContent(mes);
                    gaojianContentUeditor.setDisabled('fullscreen');
            });
        }
        if (ruleForm.gaojianShenheContent != null && ruleForm.gaojianShenheContent != 'null' && ruleForm.gaojianShenheContent != '') {
            var gaojianShenheContentUeditor = UE.getEditor('gaojianShenheContentEditor');
                gaojianShenheContentUeditor.ready(function () {
                    var mes = '' + ruleForm.gaojianShenheContent;
                    gaojianShenheContentUeditor.setContent(mes);
                    gaojianShenheContentUeditor.setDisabled('fullscreen');
            });
        }
    }
    ...
    function setDownloadBtn() {
        var gaojianFileUrl = "download('" + ruleForm.gaojianFile + "')";
        $("#gaojianFile").attr("onclick", gaojianFileUrl);
