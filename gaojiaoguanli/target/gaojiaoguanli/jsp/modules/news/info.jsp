            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">新闻登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="newsName" name="newsName" class="form-control"
                                               v-model="ruleForm.newsName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>新闻类型</label>
                                    <input id="newsValue" name="newsValue" class="form-control"
                                           v-model="ruleForm.newsValue" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>新闻图片</label>
                                    <img id="newsPhotoImg" width="100" height="100">
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.newsContent != null && ruleForm.newsContent != 'null' && ruleForm.newsContent != '') {
            var newsContentUeditor = UE.getEditor('newsContentEditor');
                newsContentUeditor.ready(function () {
                    var mes = '' + ruleForm.newsContent;
                    newsContentUeditor.setContent(mes);
                    newsContentUeditor.setDisabled('fullscreen');
            });
        }
    }
